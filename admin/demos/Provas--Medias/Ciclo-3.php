...
$grid["caption"] = "Ciclo 3 - Prova e Média Final";
...
$col = array();
$col["title"] = "Prova"; // caption of column
$col["name"] = "prova"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias)
$col["editable"] = true;
$col["required"] = true;
$cols[] = $col;

$col = array();
$col["title"] = "Game-Final"; // caption of column
$col["name"] = "game"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias)
$col["editable"] = true;
$cols[] = $col;

$col = array();
$col["title"] = "Frequencia Final"; // caption of column
$col["name"] = "frequencia_final"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias)
$col["editable"] = true;
$col["editoptions"] = array("defaultValue" => "Default Company");
$cols[] = $col;

$col = array();
$col["title"] = "Media Ciclo 3"; // caption of column
$col["name"] = "media_ciclo"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias)
$col["editable"] = true;
$col["editoptions"] = array("defaultValue" => "Default Company");
$cols[] = $col;
