...
$g->select_command = "SELECT DISTINCT a.id, a.username, a.firstname, a.lastname, a.email, b.roleid FROM mdl_user a INNER JOIN mdl_role_assignments b ON a.id = b.userid WHERE roleid = '3' ";
	
$grid["caption"] = "Tutores";
